      ...
      <Section spacing='md'>
        <Container size='md'>
          <div className='grid gap-6'>
            {COOKIE_NOTICE.page.sections.map((section) => (
