          ...
          {OFFER.primary.map((card) => (
            ...
            >
              ...
              <div className="space-y-3 pb-10 text-sm text-[#e5e2e1b3]">
                <p>
                  <span className="font-label tracking-widest text-[#e5e2e166] uppercase">
                    Vhodné pro
                  </span>
                  <br />
              ...
              <div className="mt-auto">
                <p className="font-label mb-1 text-xs tracking-widest text-[#e5e2e166] uppercase">
                  Cena od
                </p>
        ...
        <div className="mt-10 grid grid-cols-1 gap-px bg-[#5045324d] md:mt-16 lg:grid-cols-3">
          {OFFER.secondary.map((card) => (
            ...
            >
              ...
              {card.price ? (
                <p className="font-label mb-6 text-xs tracking-widest text-[#e5e2e166] uppercase">
                  Cena od
                  <br />
