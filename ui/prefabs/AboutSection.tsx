          ...
          <div className='grid grid-cols-1 items-center gap-20 lg:grid-cols-2'>
            ...
            <div className='space-y-10'>
              ...
              <div className='space-y-6 text-lg leading-relaxed text-[#e5e2e1b3]'>
                <p>
                  Živé Sklo není jen ukázka řemesla. Je to performativní
                  zážitek, který vnáší do firemních eventů prvek autenticity a
                  luxusu. Naším cílem je ukázat krásu sklářství způsobem, který
                  rezonuje s moderními standardy B2B akcí.
                </p>
                <p>
              ...
              <div className='pt-6'>
                <a
                  href='#'
                  className='border-b border-[#9accf34d] pb-1 font-display font-bold text-[#9accf3] transition-colors hover:text-[#b8ddf7]'
                >
