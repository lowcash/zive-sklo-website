          ...
          {AUDIENCE.segments.map((segment) => (
            ...
            >
              <div className='flex h-12 w-12 items-center justify-center bg-[#131313]'>
                <span className='material-symbols-outlined text-[24px] text-[#9accf3]'>{segment.icon}</span>
              </div>
              <div className='space-y-5'>
                ...
                <p className='leading-relaxed text-[#e5e2e199]'>{applyCzechNbsp(segment.description)}</p>
