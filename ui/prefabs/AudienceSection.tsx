...
export function AudienceSection() {
  return (
    <Section id='pro-koho' spacing='xl'>
      <Container>
        <h2 className='mb-12 max-w-3xl font-display text-4xl font-bold tracking-tight md:mb-20'>
        ...
        <div className='grid grid-cols-1 gap-px bg-[#5045324d] lg:grid-cols-3'>
          {AUDIENCE.segments.map((segment) => (
            <a
              ...
              className='group flex h-full flex-col gap-6 bg-[#1c1b1b] p-8 transition-colors hover:bg-[#201f1f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffbf00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#131313] lg:gap-8 lg:p-10'
            >
